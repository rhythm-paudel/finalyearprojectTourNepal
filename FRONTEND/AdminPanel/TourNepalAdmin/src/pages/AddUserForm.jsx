...
const AddUserForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.intendedDaysToStay) newErrors.intendedDaysToStay = 'Intended Days to Stay is required';
    ...
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            type="number"
            name="intendedDaysToStay"
            value={formData.intendedDaysToStay}
            onChange={handleChange}
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
          />
          {errors.intendedDaysToStay && <p className="text-red-500 text-sm mt-1">{errors.intendedDaysToStay}</p>}
        </div>
